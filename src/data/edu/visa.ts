...
export const visaWorkflow: WorkflowTopic = {
  ...
  steps: [
    ...
    },
    {
      ...
      detail: {
        documents: [
          ...
          '大學正式錄取信 Zulassungsbescheid · 適用大學簽證',
        ],
        procedure: [
          '語校:在語校官網報名並繳報名費 · 選定課程(每週 ≥ 18 小時 · 6-12 個月)',
          '大學:於 uni-assist 或大學直接申請 · 通過審核收 Zulassung',
          '匯學費並保留匯款收據',
        ],
        common_mistakes: [
          '選課程 < 18 小時/週(不符簽證要求)',
    ...
    },
    {
      ...
      outcome: ['封鎖帳戶提供財力證明 · 個人帳戶接收每月劃撥款項'],
      detail: {
        documents: [
          '護照掃描',
          '在台地址證明',
        ...
        procedure: [
          '⚠️ 重要:封鎖帳戶(Sperrkonto)不是一般銀行帳戶 · 只能用於財力證明且提領受限',
          '需要另開個人銀行帳戶(Girokonto)接收 Sperrkonto 每月劃撥的生活費(2024/25 每月約 €992)',
          '封鎖帳戶服務商:Fintiba / Expatrio / Coracle / Deutsche Bank Sperrkonto · 線上申請最快',
          '個人銀行帳戶:落地後才能辦 · N26 / Revolut(手機開戶) · Sparkasse / Deutsche Bank / Commerzbank(傳統銀行)',
          '匯款時機:預計簽證申請前 4-6 週匯入當年度金額(2024/25:€11,904)',
          '匯款到帳後收到確認信 · 作為簽證申請文件',
          '進德國後於個人帳戶收到 Sperrkonto 首次撥款(約落地 1-2 週內)',
        ],
        common_mistakes: [
          '金額不到位(未達當年度標準會被拒)',
          '想落地後補財力(不算)',
          '以為封鎖帳戶等於一般帳戶(結果無法收薪水或房租退款)',
    ...
    },
    {
      step: 6,
      title_zh: '準備文件夾',
      meta: { timing: 'Termin 前一週', docs_count: 10, priority: 'required' },
      outcome: ['避免遞件當日補件'],
      detail: {
        documents: [
        ...
        procedure: [
          '依協會清單逐項準備 · 各類別要求略有差異',
          '語言簽證:著重語校錄取通知 · 財力證明',
          '大學簽證:著重 Zulassung · 履歷 · 學業計畫',
          'Au-pair 簽證:著重家庭合約 · 對方戶籍證明',
          '職訓簽證:著重 Ausbildungsvertrag · 企業證明',
          '每份備一份正本 + 一份影本',
  ...
  general_notes: [
    '封鎖帳戶每年金額可能調整 · 正式辦理前請核對聯邦外交部最新公告',
