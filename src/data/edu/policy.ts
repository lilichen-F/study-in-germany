  ...
  steps: [
    {
      ...
      detail: {
        ...
        procedure: [
          ...
          '  · 學位歐盟互通 · ECTS 學分制',
          'ECTS 學分換算(European Credit Transfer System):',
    ...
    },
    {
      ...
      detail: {
        ...
        procedure: [
          ...
          '  · 簽證:需申請 Duale Studium 專屬簽證(非一般 Ausbildung)',
          '  · 財力:雖有薪資但可能需要初始 Sperrkonto 過渡',
          '如何申請:',
          '  1. 先於企業官網 · 或 IHK 網站查詢有 Duale Studium 開放的企業',
          '  2. 直接向企業投履歷 · 通過面試',
          '  3. 拿到企業合約後 · 再向配套大學遞件',
          '  4. 企業 + 大學雙方同意即可簽合約',
          '常見產業:',
    ...
    },
    {
      ...
      detail: {
        ...
        procedure: [
          '什麼時候需要 Anerkennung:',
          '  · 想在德國從事「受管制職業」(reglementierte Berufe)',
          ...
          '  · 各邦教育專業有邦內差異',
          '認證單位:',
          '  · KMK Zentralstelle:非受管制職業的認證',
          '  · 各邦專門機構:受管制職業(醫師 · 律師 · 教師等)',
          '    - 醫師:各邦 Landesärztekammer',
          '    - 律師:各邦 Rechtsanwaltskammer',
          '    - 教師:各邦教育部',
          '如何確認你的職業需否認證:',
          '  1. 到 anabin.kmk.org 資料庫查詢你的學歷是否對應德國職業',
          '  2. 到 Anerkennung in Deutschland 網站查詢職業是否受管制',
          '  3. 撥打當地 Chamber of Crafts(手工業) 或商會諮詢',
          '  4. 特殊情況可先詢問雇主 · 他們有處理國際學歷經驗',
          '處理時間:',
          '  · 一般 4-12 週',
          '  · 受管制職業可能 6-16 週',
        ],
