  ...
  steps: [
    {
      ...
      detail: {
        ...
        procedure: [
          ...
          '  · WG(Wohngemeinschaft):合租公寓的一間房 · 學生最常選',
          '  · Studentenwohnheim:學生宿舍 · 需向 Studentenwerk 申請 · 便宜但等候期長',
          '  · Zwischenmiete:短期轉租 · 適合 1-3 個月的過渡',
          '找房平台:',
          '  · wg-gesucht.de(WG 首選)',
    ...
    },
    {
      ...
      detail: {
        ...
        procedure: [
          ...
          '    - 洗衣 · 曬衣空間',
          '  · 費用結構:',
          '    - Kaltmiete(冷租) + Nebenkosten(水電暖氣等) = Warmmiete(暖租)',
          '    - 押金(Kaution) · 通常 2-3 個月冷租 · 房東需開專用帳戶',
          '    - 網路費是否含在內',
          '  · 房東 · WG 室友:',
          '    - 是否易於溝通',
          '    - 過去的處理糾紛態度',
          ...
          '  · 房東要求現金付押金 · 沒開專用帳戶',
          '  · 沒有正式書面租約',
          '  · 房東不願提供 Wohnungsgeberbestätigung',
          '  · 房子看起來明顯超收租金(比周邊高 30%+)',
          '  · 房東急著催你簽 · 不給看合約條款時間',
          '  · WG 室友明顯避開回答共同開銷',
        ],
    ...
    },
    {
      ...
      outcome: ['確保能在 14 天內完成 Anmeldung(所有後續事項的基礎)'],
      detail: {
        documents: ['房東確認書 Wohnungsgeberbestätigung'],
        procedure: [
          '⚠️ 極重要 · 不是所有租約都能辦戶籍',
          '可辦戶籍的類型:',
          '  · 有正式 Mietvertrag 且房東願提供 Wohnungsgeberbestätigung',
          '  · WG 內主承租人(Hauptmieter)願為你當「Untermieter」開此文件',
          '  · Studentenwerk 宿舍(自動可辦)',
          '不可辦戶籍的類型:',
          '  · Airbnb 或短租平台(即使住幾個月 · 房東不會開文件)',
          '  · Zwischenmiete 中 · 主承租人不在 · 沒人開文件',
          '  · WG 内非法轉租(主承租人向房東隱瞞)',
          '  · 有些青年旅館',
          '簽約前一定要問:',
          '  1. 「你會幫我開 Wohnungsgeberbestätigung 嗎?」',
          '  2. 「多久內可以開好?」(通常 1-2 週)',
          '  3. 若是 WG · 「主承租人是誰?他同意我當 Untermieter 嗎?」',
          '為什麼重要:',
          '  · 沒 Anmeldung → 開不了銀行帳戶',
          '  · 沒 Anmeldung → 辦不了保險 · 尤其公保',
          '  · 沒 Anmeldung → 拿不到 Steuer ID(稅號)',
          '  · 沒 Anmeldung → 無法辦圖書館證 · 學生福利',
          '  · 沒 Anmeldung → 無法申請 Aufenthaltstitel',
        ],
        common_mistakes: [
    ...
    },
    {
      ...
      detail: {
        documents: [
          ...
          'Anmeldung 表單(現場填寫 · 或先線上下載)',
        ],
        procedure: [
          '線上預約 Bürgeramt Termin(大城市需 2-4 週前預約)',
          '準時到場 · 帶齊文件',
          '簽名並繳表格',
          '收 Meldebescheinigung(戶籍證明) · 妥善保存',
        ],
        common_mistakes: [
          '柏林 · 慕尼黑 Termin 難搶 · 落地前一週就要開始盯',
          '資料填錯地址(未來所有事都會出錯)',
          'Meldebescheinigung 遺失 · 重辦需錢和時間',
        ],
        official_sources: [
    ...
    },
    {
      ...
      outcome: ['接收薪水 / 獎學金 · 繳費 · 接收 Sperrkonto 撥款'],
      detail: {
        documents: ['護照', 'Meldebescheinigung', '學生證(若已有)'],
        procedure: [
          '傳統銀行(Sparkasse · Deutsche Bank · Commerzbank):預約 Termin · 現場辦理',
          'Neobank(N26 · Revolut · Vivid):手機 App 開戶 · 5 分鐘完成',
          '建議:Neobank 為主帳戶(收 Sperrkonto 撥款 · 日常花費) · Sparkasse 為備用(現金業務 · 部分房東要求)',
        ],
        common_mistakes: [
    ...
    },
    {
      ...
      detail: {
        ...
        procedure: [
          '語校生 · 職訓生:續用出發前買的私保',
          '正式大學生(有 Immatrikulation):TK / AOK / Barmer 等公保 · 約 €120/月',
    ...
    },
    {
      ...
      meta: { timing: 'Anmeldung 後自動寄送', priority: 'required' },
      outcome: ['開始工作或報稅'],
      detail: {
        documents: [],
        procedure: [
          'Anmeldung 完成後 · 稅務局(Finanzamt)會於 3-6 週內寄稅號到你的地址',
          '若一直未收到 · 可寫信給 Finanzamt 索取',
        ],
        common_mistakes: [
          'Anmeldung 地址錯 · 稅號沒收到',
          '未妥善保管稅號 · 之後找工作找不到',
    ...
    },
    {
      ...
      detail: {
        ...
        procedure: [
          'Prepaid(預付):Aldi Talk / Lidl Connect / Callya · 超市買 · €10-20/月',
